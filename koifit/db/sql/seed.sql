...
('Overhead Cable Triceps Extension (BRA)', 1.0, 'Triceps', 'Measured in pressure, not kg. Both arms at once, resist the negative'),
...
('Triceps Pressdown (BRA)', 1.0, 'Triceps', 'Measured in pressure, not kg. Squeeze triceps to move weight'),
